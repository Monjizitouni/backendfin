...
data.forEach(   async element => {
    ...
    console.log("this is the element:"+ element);
        ...
        await getcontrat1(element.COD_TYP_CONTRAT).then(function (result) {
...
async function getcontrat1(codetypecontrat){
...
console.log(data)
    let data1 = await TQP.find({ 
        NUM_QP: data[0].NUM_QP } ).select('INTITULE_QP NUM_QT DATE_QP')
    res.send(data1);
